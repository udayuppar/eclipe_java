...
import com.uday.copies.things.History;
...
public class HistoryRunner {
	...
	public static void main(String[] args) {
		...
		History pass = new History("Aegonr", "ALicent", "Mario Puzo", 1, true, items1, items2, items3, items4, items5,
				items6, Villages.NAGASANDRA);

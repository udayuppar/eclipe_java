...
import com.uday.copies.things.BangalorePlaces;

public class BangalorePlacesRunner {
	...
	public static void main(String[] args) {
		...
		BangalorePlaces electronCity = new BangalorePlaces("Nandi Hils", 'S', "India", 1, true, items1, items2, items3,
				items4, items5, items6);

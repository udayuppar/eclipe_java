...
public class AutoMobile {
	...
	public AutoMobile(String name, char type, String cars, int noOfCars, boolean topEnd, String[] carsName,
			String[] companyLocation, String[] carsLogo, double[] price, long[] totalVehicleDelivered,

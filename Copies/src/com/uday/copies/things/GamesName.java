...
public class GamesName {
	     ...
	     public GamesName(String ubisoft,char type,String uniralEngine,int  noOfGames,boolean gameForAdults,String[] allGames,String[] characterNames,String[] playersNames,double[] gamesPrice,long[] noOfBuyers,String[] missions)
	     {

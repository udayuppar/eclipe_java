...
import com.uday.copies.constructerr.Villages;
...
public class History {
	...
	public String[] wars;
	public Villages NAGASANDRA;

	public History(String kingName, String queenName, String writer, int Soldiers, boolean theKingIsDead,
			String[] hisCommanders, String[] writerNames, String[] typesOfFlags, double[] hisProperty,
			long[] typesOfSoldiers, String[] wars, Villages NAGASANDRA) {
	...
	public void display() {
		...
		System.out.println(this.NAGASANDRA);

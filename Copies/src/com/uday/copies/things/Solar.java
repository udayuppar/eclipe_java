...
public class Solar {
	...
	public Solar(String Planet, char type, String galaxyName, int positionOfPlanet, boolean livingExist,
			String[] planets, String[] galaxies, String[] naturalSatellite, double[] planetsWeights,
			long[] noNaturalSatellite, String[] missions, Planet EARTH) {

...
import com.uday.inheritence.things.equality.things.Currancy;
import com.uday.inheritence.things.equality.things.God;
import com.uday.inheritence.things.equality.things.Hospital;
import com.uday.inheritence.things.equality.things.Institution;
import com.uday.inheritence.things.equality.things.Lipstik;
import com.uday.inheritence.things.equality.things.Paint;
import com.uday.inheritence.things.equality.things.Vehicle;
import com.uday.inheritence.things.equality.things.WaterBottel;
...
public class PaintRunner {
	...
	public static void main(String[] args) {
		...
		Paint paint2=new Paint("Royale", "Asian Paints","Red", 5000,"Sapthagiri", "22/11/2022", 1, false, 10, "uday");
		...
		// paint=paint2;
		 ...
		 Vehicle vehicle2=new Vehicle("Royal enfeild", "Himalayan", 350000, "Arun", "enfeild", 20, false, "KA-66-515", "loan", "tarikere");
		 ...
		 WaterBottel bottel2=new WaterBottel("Kinley", "Kinley", 10, "Shashi", "2.0", 450, true, true, 20, "normal");
		 ...
		 Currancy currancy=new Currancy();
			...
			Lipstik lips2=new Lipstik("lakme", "lipstik",800, "red", "f", "soft", "Girls", 25, "Shivmogga", "Karnataka", null);
